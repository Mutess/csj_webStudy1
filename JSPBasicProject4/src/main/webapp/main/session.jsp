...
<table class="table">
	<tr>
		...
		<td width="80%">HttpSession(request로 생성이 가능:request.getSesseion())
		<br>
	...
	<tr>
		...
		<td width="80%">
			<ul>
				...
				<li>전역변수러 사용이 가능 (모든 JSP에서 사용이 가능)</li>
	...
	<tr>
		...
		<td width=80%>
			<ul>
				...
				<li>저장기간설정:setMaxinactiveInterval(int time):1/1000=> default</li>
				<li>저장되는 기간 : 30분</li>
