...
<body>
	...
	<table class="table">
		...
		<tr>
			...
			<td width="75%">서버에서 응답정보, 화면이동 정보, Header정보</td>
		</tr>
		<tr>
			<td width="25%">out</td>
			<td width="75%">출력 버퍼와 관련, 화면 출력정보</td>
			<br><sub>출력버퍼:실행된 HTML를 저장하는 공간(이 공간을 브라우저에 읽어감)</sub>
		</tr>
		<tr>
			<td width="25%">application</td>
			<td width="75%">서버정보, 자원정보, 로그 정보</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td width="75%">페이지의 흐름(request):JSP여려개 조립</td>
		</tr>
		<tr>
