  	...
  	<main class="container clear"> 
  		<h2 class="sectiontitle">회원가입</h2>
  			<div class="row">
  				...
  				<table class="table">
  					<tr>
  						<th class="text-rigth" width=10%>ID</th>
  					...
  					<tr>
  						<th class="text-rigth" width=10%>비밀번호</th>
  						<td width="90%" class="inline">
  					...
  					<tr>
  						<th class="text-rigth" width=10%>이름</th>
  						<td width="90%" class="inline">
  							<input type="text" name=name id=name size=20 class="input-sm">
  						</td>
  					</tr>
  						<tr>
  						<th class="text-rigth" width=10%>성별</th>
  						<td width="90%" class="inline">
  					...
  					<tr>
  						<th class="text-rigth" width=10%>생년월일</th>
  						<td width="90%" class="inline">
  							<input type="date" name=birthday size=20 >
  						</td>
  					</tr>
  					<tr>
  						<th class="text-rigth" width=10%>이메일</th>
  						<td width="90%" class="inline">
  					...
  					<tr>
  						<th class="text-rigth" width=10%>우편번호</th>
  						<td width="90%" class="inline">
  					...
  					<tr>
  						<th class="text-rigth" width=10%>주소</th>
  						<td width="90%" class="inline">
  							<input type="text" name=addr1 id=addr2 size=55 class="input-sm" readonly>
  						</td>
  					</tr>
  					<tr>
  						<th class="text-rigth" width=10%>상세주소</th>
  						<td width="90%" class="inline">
  							<input type="text" name=addr2 id=addr2 size=55 class="input-sm">
  						</td>
  					</tr>
  					<tr>
  						<th class="text-rigth" width=10%>전화번호</th>
  						<td width="90%" class="inline">
  							<select name=phone1 class="input-sm">
  								<option>010</option>
  							</select>
  							<input type="text" name=phone id=phone size=12 class="input-sm">
  							<input type="button" value="전화번호체크" class="btn btn-sm btn-warning" id="phoneBtn">
  						</td>
  					</tr>
  					<tr>
  						<th class="text-rigth" width=10%>소개</th>
  						<td width="90%" class="inline">
