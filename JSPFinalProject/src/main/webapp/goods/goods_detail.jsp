...
<%--
	...
	2) 서버
		...
		=> JSP에서는 request에 들어가 있는 데이터를 출력하기 쉽게 ${} (EL),
		 	자바에서 제공하는 제어문 , 메소드...
		 	---------------------------
		 		태그형으로 변경 (JSTL)
  		...
  		<main class="container clear">
  			<div class="row">
  				<table class="table">
  					...
  					<tr>
  						<td>배송&nbsp;&nbsp;<span style="color: ;">${vo.goods_delivery }</span></td>
  					</tr>
  					<tr>
  						<td class="inline">
  					...
  					<tr>
  						<td class="inline">
  							...
  							<input type="button" class="btn btn-lg btn-info" value="바로구매" style="width: 200px" id="byBtn">
  						</td>
  					</tr>
  					</c:if>
  				</table>
