...
<jsp:useBean id="dao" class="com.sist.dao.FoodDAO17"/>
<%
	//1. 사용자가 보내준 값을 받는다.
...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=b5203b97e62633c04cb8e55d2e14616d&libraries=services"></script>
</head>
<body>
	<div class="container">
		<div class="row">
